$(function() {
  ...
  CMS.init({
    ...
    siteName: 'Josh CMS.js POC',

    // Tagline for your site
    siteTagline: 'Testing simple things... :)',

    // Email address
    siteEmail: 'josuebasurto@gmail.com',
    ...
    // Navigation items
    siteNavItems: [
      { name: 'Github', href: 'https://github.com/josuebasurto', newWindow: false},
      { name: 'About'}
    ],
